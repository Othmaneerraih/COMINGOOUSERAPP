...
//                        callback.callbackCall(true, drivrNam, drivrImg, drivrNum, debt, todystrp, todysErn, rat, driverId);
    ...
    void checkCourseTask(final CourseCallBack callback) {
                    ...
                    for (final DataSnapshot data : dataSnapshot.getChildren()) {
                        ...
                        if (data.child("endLat").getValue(String.class) != null) {
                            if (Objects.equals(data.child("endLat").getValue(String.class), "")) {
                                ...
                                driverArraivalLatLong = new LatLng(Double.parseDouble(Objects.requireNonNull(data.child("endLat").getValue(String.class))),
                                        Double.parseDouble(Objects.requireNonNull(data.child("endLong").getValue(String.class))));
                            }
                        }
                            ...
                            FirebaseDatabase.getInstance().getReference("clientUSERS").
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    if (dataSnapshot.exists()) {
                                        ...
                                        isPromoCode = dataSnapshot.child("PROMOCODE").exists();
...
//                                                            Log.e(TAG, "date of ride: " + Objects.requireNonNull(child.child("date").getValue()).toString());
                                                            ...
                                                            clientLastRideDate = convertDate(longV, "dd/MM/yyyy hh:mm:ss");
...
//                                        });
    ...
    void gettingPriceValue(final PriceCallBack priceCallBack) {
        FirebaseDatabase.getInstance().getReference("DRIVERUSERS").
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    try {
                        driverDebt = Double.parseDouble(Objects.requireNonNull(dataSnapshot.child("debt").getValue(String.class)));
                        earned = Double.parseDouble(Objects.requireNonNull(dataSnapshot.child("EARNINGS").child(getDateMonth(GetUnixTime())).
                                child(getDateDay(GetUnixTime())).child("earnings").getValue(String.class)));
                        voyages = Integer.parseInt(Objects.requireNonNull(dataSnapshot.child("EARNINGS").child(getDateMonth(GetUnixTime())).
        ...
        FirebaseDatabase.getInstance().getReference("PRICES").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    double att = Double.parseDouble(Objects.requireNonNull(dataSnapshot.child("att").getValue(String.class)));
                    double base = Double.parseDouble(Objects.requireNonNull(dataSnapshot.child("base").getValue(String.class)));
                    double debtCeil = Double.parseDouble(Objects.requireNonNull(dataSnapshot.child("debtCeil").getValue(String.class)));
                    double km = Double.parseDouble(Objects.requireNonNull(dataSnapshot.child("km").getValue(String.class)));
                    double min = Double.parseDouble(Objects.requireNonNull(dataSnapshot.child("minimum").getValue(String.class)));
                    final double percent = Double.parseDouble(Objects.requireNonNull(dataSnapshot.child("percent").getValue(String.class)));
    ...
    void rateClient(final int Rate) {

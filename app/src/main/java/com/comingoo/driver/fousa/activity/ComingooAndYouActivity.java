...
public class ComingooAndYouActivity extends AppCompatActivity {
    private String TAG = "ComingooAndYouActivity";
    ...
    private void addNewCar(String marque, String modele, String imm, String colorCar) {
        if (marque.length() >= 3 && modele.length() >= 3 && imm.length() >= 3 && colorCar.length() >= 3) {
            ...
            Toast.makeText(ComingooAndYouActivity.this, "Tous les champs doivent étres remplis!!", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void updateUI() {
        ...
        switch (selectedScreen) {
            case 0:
                CustomAnimation.fadeIn(ComingooAndYouActivity.this, parametreLayout, 500, 10);
                break;
            case 1:
                CustomAnimation.fadeIn(ComingooAndYouActivity.this, profileLayout, 500, 10);
                break;
            case 2:
                CustomAnimation.fadeIn(ComingooAndYouActivity.this, addCarLayout, 500, 10);
                break;
            case 3:
                CustomAnimation.fadeIn(ComingooAndYouActivity.this, changePasswordLayout, 500, 10);
                break;
            case 4:
                CustomAnimation.fadeIn(ComingooAndYouActivity.this, carsLayout, 500, 10);
                break;
            case 5:
                CustomAnimation.fadeIn(ComingooAndYouActivity.this, portFeuilleLayout, 500, 10);
                break;
            case 6:
                CustomAnimation.fadeIn(ComingooAndYouActivity.this, tarifsLayout, 500, 10);
                break;
        }
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (dataSnapshot.exists()) {
                        ...
                        if (oldPassword.equals(dataSnapshot.child("password").getValue(String.class))) {
                            Toast.makeText(ComingooAndYouActivity.this, "Mot de passe changé!", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(ComingooAndYouActivity.this, "Mot de passe erroné", Toast.LENGTH_SHORT).show();
                            changePassBtn.setVisibility(View.VISIBLE);
                            findViewById(R.id.progressBar).setVisibility(View.GONE);
                        }
                    }

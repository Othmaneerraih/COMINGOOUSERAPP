...
//        new LocationUpdatesTask().execute();
    ...
    int preWait = 0;
    double ridePrice = 0;
    private double price1, price2, price3, promoCode;
    double currentBil = 0;
...
//                                        Log.e(TAG, "onDataChange: Ujjwal step 1:"+price );
//                                        if (price < min) {
//                                            price = min;
//                                        }
//
//                                        Log.e(TAG, "onDataChange: Ujjwal step 2:" + price );
//
//                                        final double getPrice = price;
...
//
//
//                                                        final float driverrAlreadyHave = debt;
//
...
//                                                            @Override
//                                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
//                                                                if (dataSnapshot.child("USECREDIT").getValue(String.class).equals("1") && Integer.parseInt(dataSnapshot.child("SOLDE").getValue(String.class)) >= (int) getPrice) {
//                                                                    int newSolde = Integer.parseInt(dataSnapshot.child("SOLDE").getValue(String.class)) - (int) getPrice;
...
//
//                                                                    float newDebt = (driverrAlreadyHave - (float) getPrice) + (float) (getPrice * percent);
...
//                                                                    FirebaseDatabase.getInstance().getReference("DRIVERUSERS").child(userId).child("debt").setValue(Float.toString((float) (driverrAlreadyHave + (float) (getPrice * percent))));
//                                                                }
//                                                            }
//
//                                                            @Override
...
//                                                        FirebaseDatabase.getInstance().getReference("clientUSERS").child(clientID).child("LASTCOURSE").setValue("Derniére course : Captain " + driverName + " / " + getPrice + " MAD");
...
//                                                                                    MapsActivity.price.setText("0.0 MAD");
//
//                                                                                } else {
...
//
//                                                                                    MapsActivity.price.setText(String.format("%.2f", userDue) + " MAD");
//
//                                                                                    FirebaseDatabase.getInstance().getReference("DRIVERUSERS").child(userId).child("debt").setValue(Double.toString(newDebt));
//                                                                                }
...
//                                                                                MapsActivity. price.setText(String.format("%.2f", ridePrice) + " MAD");
//                                                                            } catch (NumberFormatException e) {
//                                                                                e.printStackTrace();
//                                                                            } catch (Exception e) {
//                                                                                e.printStackTrace();
...
//                        });
    ...
    private class GeoCoderTask extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            if (startPos != null) {
                ...
                try {
                    listAddresses = geocoder.getFromLocation(startPos.latitude, startPos.longitude, 1);
                    if (listAddresses.get(0) != null && listAddresses.size() > 0) {
                        if (listAddresses.get(0).getThoroughfare() != null)
                            startAddress = listAddresses.get(0).getThoroughfare();

                        if (listAddresses.get(0).getLocality() != null)
                            startAddress += listAddresses.get(0).getLocality();
            ...
            if (endPos != null) {
                ...
                List<Address> listAddresses = null;
                try {
                    listAddresses = geocoder.getFromLocation(endPos.latitude, endPos.longitude, 1);
                    if (listAddresses.get(0) != null && listAddresses.size() > 0) {
                        if (listAddresses.get(0).getThoroughfare() != null)
                            endAddress = listAddresses.get(0).getThoroughfare();

                        if (listAddresses.get(0).getLocality() != null)
                            endAddress += listAddresses.get(0).getLocality();
